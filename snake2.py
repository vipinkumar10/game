...
# Helper functions
''' return location of food item'''
def on_grid_random():
    x = random.randint(0, 59)  # x coordinate
    y = random.randint(0, 59)  # y coordinate
    return x * 10, y * 10  # grid of 590*590
...
snake_skin = pygame.Surface((10, 10))  # snake initial size
